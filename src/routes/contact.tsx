              ...
              <div className="glass-panel p-10 rounded-xl custom-shadow">
                ...
                <form className="space-y-6" onSubmit={onSubmit}>
                  ...
                  <motion.button
                    ...
                    className={`w-full py-4 font-button-text rounded-lg shadow-lg transition-all ${status === "sent" ? "bg-green-600 text-white" : "bg-primary text-on-primary"} ${status === "sending" ? "opacity-60" : ""}`}
                  >
          ...
          <div className="max-w-container-max mx-auto px-margin-desktop">
            ...
            <StaggerGrid className="grid grid-cols-1 md:grid-cols-3 gap-gutter" staggerDelay={0.12}>
              {[
                ...
                <StaggerItem key={r.t}>
                  <div className="p-8 rounded-xl bg-primary-container border border-on-primary-container/10 hover:border-secondary-fixed transition-colors hover:-translate-y-1 duration-300">
...
const inputClass =
  "border border-outline-variant bg-surface-container-low focus:border-secondary focus:ring-secondary focus:outline-none rounded-lg px-4 py-3 font-body-rt text-body-rt w-full transition-colors duration-200";
