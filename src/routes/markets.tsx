      ...
      <main className="pt-20">
            ...
            <div className="relative w-full aspect-[21/9] bg-primary/20 rounded-xl border border-white/5 p-4 overflow-hidden">
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                {[
                  ...
                  <div key={i} className="absolute w-4 h-4 bg-secondary-fixed rounded-full animate-pulse-gold shadow-[0_0_15px_rgba(255,222,170,0.6)]" style={m} />
                ))}
              </div>
        ...
        <section className="py-section-gap px-margin-desktop max-w-container-max mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
            ...
            <div className="md:col-span-4 bg-primary text-on-primary p-10 market-card-shadow flex flex-col justify-between">
              <div>
          ...
          <div className="px-margin-desktop max-w-container-max mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {[
                ...
                <div key={p.title} className="bg-white p-8 market-card-shadow border border-outline-variant/30 flex gap-6">
