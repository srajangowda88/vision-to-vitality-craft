    ...
    <div className="bg-background text-on-background grain-texture">
      ...
      <main className="pt-20">
        ...
        <section className="py-section-gap px-margin-desktop max-w-container-max mx-auto">
          ...
          <StaggerGrid className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter" staggerDelay={0.1}>
            {services.map((s) => (
              <StaggerItem key={s.t}>
                <div className="glass-card p-10 flex flex-col group hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
